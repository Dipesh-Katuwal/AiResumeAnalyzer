...
import { assetUrl, formatSize } from "../lib/utils";
...
const FileUploader = ({ onFileSelect, inputId }: FileUploaderProps) => {
  ...
  return (
    <div className="w-full gradient-border">
      <div
        {...getRootProps()}
        className="flex min-h-45 items-center justify-center rounded-xl"
      >
